...
function HomeClient() {
  return (
    <div className="relative min-h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <MotionImage initial={{ opacity: 0, x: -400, y: 100 }} animate={{ opacity: 1, x: 0, y: 0 }} transition={{ duration: 1, delay: 0.2, ease: easeOut }} alt="" src={ImageDonCoffe1} className="w-[118px] h-[103px] mr-[38vh] mt-[20vh] shadow-done-coffe absolute"/>
        <MotionImage initial={{ opacity: 0, x: -400, y: 100 }} animate={{ opacity: 1, x: 0, y: 0 }} transition={{ duration: 1, delay: 0.2, ease: easeOut }} alt="" src={ImageDonCoffe3} className="w-[120px] h-[104px] rotate-[5deg] mr-[50vh] mt-[68vh] shadow-done-coffe absolute"/>
        <MotionImage initial={{ opacity: 0, x: 400, y: 100 }} animate={{ opacity: 1, x: 0, y: 0 }} transition={{ duration: 1, delay: 0.2, ease: easeOut }} alt="" src={ImageDonCoffe2} className="w-[97px] h-[90px] mt-[24vh] shadow-done-coffe absolute mr-[155vh]"/>
        <MotionImage initial={{ opacity: 0, x: 300, y: 500 }} animate={{ opacity: 1, x: 0, y: 0 }} transition={{ duration: 1, delay: 0.2, ease: easeOut }} alt="" src={ImageDonCoffe2} className="w-[90px] h-20 mt-[75vh] rotate-[-70deg] shadow-done-coffe absolute mr-[164vh]"/>
      </div>
